...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_maestro_fz1bUI* ui = (gx_maestro_fz1bUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    set_expose_func(GX_FZ1B_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    set_expose_func(GX_FZ1B_PAINT_BOX(ui->pf1box),"frame_expose");
