...
static LV2UI_Handle instantiate(const struct _LV2UI_Descriptor * descriptor,
	...
	ui->controls[0] = { 1.0, 1.0, 0.0, 1.0, 1.0, 35, 60, 61, 61, false,"POWER", BSWITCH, BYPASS};
	ui->controls[1] = { 0.5, 0.5, 0.0, 1.0, 0.01, 120, 60, 61, 61, false,"BALANCE", KNOB, BALANCE};
	ui->controls[2] = { 0.5, 0.5, 0.0, 1.0, 0.01, 205, 60, 61, 61, false,"VOLUME", KNOB, VOLUME};
