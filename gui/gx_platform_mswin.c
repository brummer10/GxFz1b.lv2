...
void gx_gui_create_window_and_surface(gx_maestro_fz1bUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_maestro_fz1bUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_maestro_fz1bUI *ui) {
	...
	UnregisterClass(TEXT("gx_maestro_fz1bUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_maestro_fz1bUI *ui = (gx_maestro_fz1bUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
